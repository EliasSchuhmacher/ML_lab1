...
def backfill_predictions_for_monitoring(weather_fg, air_quality_df, monitor_fg, model):
    ...
    features_df['predicted_pm25'] = model.predict(features_df[['rolling_mean_pm25', 'temperature_2m_mean', 'precipitation_sum', 'wind_speed_10m_max', 'wind_direction_10m_dominant']])
...
# def backfill_predictions_for_monitoring_new(weather_fg, air_quality_df, monitor_fg, model):
#     features_df = weather_fg.read()
#     features_df = features_df.sort_values(by=['date'], ascending=True)
#     features_df = features_df.tail(10)
#     features_df['predicted_pm25'] = model.predict(features_df[['rolling_mean_pm25', 'temperature_2m_mean', 'precipitation_sum', 'wind_speed_10m_max', 'wind_direction_10m_dominant']])
